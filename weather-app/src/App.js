    ...
    <div className="container">
      ...
      <div className="content">
        <div className="form-container">
          <div className="name">
            <div className="logo"> WeatherMaster <hr></hr></div>
            <div className="city">
              <TbMapSearch />
              <p>{city}</p>
            </div>
          ...
          <div className="search">
            <h2>Weather App You Need !</h2>
            <hr />
            <form className="search-bar" noValidate onSubmit={handleSubmit}>
              <input type="text" name="" id="" placeholder='Search for City' onChange={handleChange} required/>
